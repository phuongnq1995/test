...
export const Book = (props: IBookProps) => {
  ...
  return (
    <div>
      <h2 id="book-heading">
        <Translate contentKey="testApp.book.home.title">Books</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="testApp.book.home.createLabel">Create new Book</Translate>
        </Link>
      </h2>
          ...
          {bookList && bookList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="testApp.book.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('description')}>
                    <Translate contentKey="testApp.book.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('publicationDate')}>
                    <Translate contentKey="testApp.book.publicationDate">Publication Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="testApp.book.home.notFound">No Books found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
